...
from Hypernet2 import HyperNetwork
import time
...
train_input, fs = torchaudio.load(r'D:\fau\magisterka\spice\out\train\\' + data + '-input.wav')
train_target, fs = torchaudio.load(r'D:\fau\magisterka\spice\out\train\\' + data + '-target.wav')
val_input, fs = torchaudio.load(r'D:\fau\magisterka\spice\out\val\\' + data + '-input.wav')
val_target, fs = torchaudio.load(r'D:\fau\magisterka\spice\out\val\\' + data + '-target.wav')

r'''
train_input, fs = torchaudio.load(r'D:\fau\magisterka\KLANN\data\train\\' + data + '-input.wav')
train_target, fs = torchaudio.load(r'D:\fau\magisterka\KLANN\data\train\\' + data + '-target.wav')
val_input, fs = torchaudio.load(r'D:\fau\magisterka\KLANN\data\val\\' + data + '-input.wav')
val_target, fs = torchaudio.load(r'D:\fau\magisterka\KLANN\data\val\\' + data + '-target.wav')
'''
# DataLoader
...
print("Time elapsed: ", (time.time() - t0) / 60, " mins")
